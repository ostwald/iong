...
class CustomerEmailEntry (CustomerEntry):
    ...
    def render_header(self, parent):
        ...
        header = H2 (email, klass='customer-header')
...
def render_index_page():
    doc = CustomerEmailOrderIndexDoc ()
    doc.render()
    doc.write()

def main (letter, outpath='orderByEmail_TESTER'):

    doc = CustomerEmailOrderHtmlDoc (index_letter=letter)
    doc.render()
    doc.write()
